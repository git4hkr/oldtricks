...
/**
 * Defines the algorithm for searching handler methods exhaustively including
 * interfaces and parent classes while also dealing with parameterized methods
 * as well as interface and class-based proxies.
 * 
...
public abstract class HandlerMethodSelector {
	 ...
	 *            a {@link MethodFilter} to help recognize handler methods of
	 *            interest
